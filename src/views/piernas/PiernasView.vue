    ...
    <div class="group-header">
      <div class="header-content">
        ...
        <div class="benefits-block">
          <h3 class="benefits-title">Beneficios de entrenar piernas</h3>
...
const sectionData = {
  name: 'Piernas',
  eyebrow: 'Sección de piernas',
  title: 'Piernas fuertes y definidas',
  subtitle: 'Desarrolla cuádriceps y pantorrillas. Piernas proporcionadas, fuertes y bien formadas.',
  benefits: [
    'Piernas grandes y voluminosas',
    'Cuádriceps definidos y marcados',
