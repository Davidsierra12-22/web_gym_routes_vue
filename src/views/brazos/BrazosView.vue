    ...
    <div class="group-header">
      <div class="header-content">
        ...
        <div class="benefits-block">
          <h3 class="benefits-title">Beneficios de entrenar brazos</h3>
...
const sectionData = {
  name: 'Brazos',
  eyebrow: 'Sección de brazos',
  title: 'Desarrolla brazos poderosos',
  subtitle: 'Consigue brazos voluminosos y definidos. Entrena bíceps, tríceps y antebrazos para lucir brazos de ensueño.',
  benefits: [
    'Brazos más grandes y voluminosos',
    'Bíceps y tríceps definidos',
    'Mayor agarre y fuerza',
    'Brazos tonificados y marcados',
    'Proporción perfecta del cuerpo'
  ]
}
